...
import (
	...
	"github.com/digitranslab/kozmo-sandbox/internal/core/runner"
	python_dependencies "github.com/digitranslab/kozmo-sandbox/internal/core/runner/python/dependencies"
...
func InstallDependencies(requirements string) error {
	...
	return runner.WithTempDir("/", []string{}, func(root_path string) error {
		...
		pipMirrorURL := static.GetKozmoSandboxGlobalConfigurations().PythonPipMirrorURL
